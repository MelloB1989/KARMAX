...
export const CONNECTOR_SETUPS: Record<string, ConnectorSetup> = {
  slack: {
    ...
    fields: [
      { key: "bot_token", label: "Bot User OAuth Token", type: "secret", placeholder: "xoxb-...", required: true, set: false },
      { key: "signing_secret", label: "Signing Secret", type: "secret", placeholder: "", required: true, set: false },
    ],
  ...
  github: {
    ...
    fields: [
      { key: "app_id", label: "App ID", type: "text", required: true, set: false },
      { key: "installation_id", label: "Installation ID", type: "text", required: true, set: false },
      { key: "private_key", label: "Private key (PEM)", type: "secret", required: true, set: false },
    ],
  ...
  jira: {
    ...
    fields: [
      { key: "site_url", label: "Site URL", type: "url", placeholder: "https://acme.atlassian.net", required: true, set: false },
      { key: "email", label: "Account email", type: "text", placeholder: "you@acme.com", required: true, set: false },
      { key: "api_token", label: "API token", type: "secret", required: true, set: false },
    ],
